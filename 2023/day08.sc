...
val part1 = instructions.scanLeft("AAA")(next).indexOf("ZZZ")

def stepsToZ(from: String): Long = instructions.scanLeft(from)(next).indexWhere(_.takeRight(1) == "Z")
